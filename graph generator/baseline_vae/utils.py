...
from config import (NODE_TYPES, EDGE_TYPES, MAX_NODES, NODE_FEATURE_SIZE)
...
def gvae_loss(triu_logits,node_logits,feature_logits, edge_index,node_types,node_features, mu, logvar, batch_index, kl_beta):
    """
