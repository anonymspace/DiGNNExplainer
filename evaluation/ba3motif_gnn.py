...
for i in range(0,10):
    ...
    for filepath in glob.iglob(graphs_path + 'ba3/*.gexf'):
        ...
        #small_graph.y = random.choice([0,1,2])
        small_graph.y = small_graph['class'][0]
        ...
        softmax, correct_pred = evaluate_gnn(small_graph)
...
def get_avg_fidelity(graph_list):
    ...
    for i, expln_graph in enumerate(graph_list):
        ...
        fid_score_list = []
        if i == 0:
            motifs_path = '../../baseline_explainers/motifs_real/motif_ba3/motif_ba3_class0/'
        elif i == 1:
            motifs_path = '../../baseline_explainers/motifs_real/motif_ba3/motif_ba3_class1/'
        elif i == 2:
            motifs_path = '../../baseline_explainers/motifs_real/motif_ba3/motif_ba3_class2/'
