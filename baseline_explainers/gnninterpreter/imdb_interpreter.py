...
def test_interpreter(target_class, show=False):
    ...
    for seed in [15]:
        ...
        model.load_state_dict(torch.load('ckpts/imdb_ckpt.pt'))
...
if __name__ == "__main__":
    ...
    print('Average faithfulness for 5-10 node sizes', np.mean(mean_faithfulness_list))
    print('Average probability for 5-10 node sizes', np.mean(avg_prob_list))
