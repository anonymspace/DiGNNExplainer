...
def get_avg_fidelity(graph_list):
    ...
    for i, expln_graph in enumerate(graph_list):
        ...
        fid_score_list = []
        if i == 0:
            motifs_path = '../motifs_real/motif_ba3/motif_ba3_class0/'
        elif i == 1:
            motifs_path = '../motifs_real/motif_ba3/motif_ba3_class1/'
        elif i == 2:
            motifs_path = '../motifs_real/motif_ba3/motif_ba3_class2/'
