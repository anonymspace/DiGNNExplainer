...
class Syn_GCN_TC(torch.nn.Module):
    def __init__(self, num_unit, n_input, n_out, n_hid):
        super(Syn_GCN_TC, self).__init__()
...
if __name__ == "__main__":
    ...
    model = Syn_GCN_TC(args.num_unit, n_input=n_input, n_out=n_labels, n_hid=args.hidden).to(device)
