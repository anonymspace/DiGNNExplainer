...
class gnn_explain():
    def __init__(self, max_node, max_step, target_class, max_iters): 
        ...
        self.gnnNets = gcn_nc.GCN(8,16,8)
        ...
        self.max_poss_degree = {0: 1, 1: 3, 2: 1, 3: 2,4: 4, 5: 6, 6: 9, 7: 10}
        

    def train(self):
        ####given the well-trained model
        ### Load the model
        checkpoint = torch.load('checkpoint/pubmed_gcn.pth')
                ...
                if  flag == True: #### add edge  successfully
                    if validity == True:                        
                        ...
                        if correct_indices:
                            ...
                            reward_pred = probs.ravel()[self.target_class]- 0.05 # positive reward
                        else:
